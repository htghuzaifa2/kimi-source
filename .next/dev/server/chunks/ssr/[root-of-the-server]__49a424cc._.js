...
const AssistiveTouch = ()=>{
    ...
    const FRICTION = 0.98; // Lower friction for longer spin
    const ANGLE_STEP = 360 / 14; // Auto-calculate based on 14 items (approx 25.7deg)
    ...
    const moveRotation = (e)=>{
        ...
        // "Slow and smooth" - reduced sensitivity factor from 0.5 to 0.15
    ...
    const getItemStyle = (index)=>{
        ...
        // Staggered delay based on index for "Pop out" effect
...
//# sourceMappingURL=%5Broot-of-the-server%5D__49a424cc._.js.map