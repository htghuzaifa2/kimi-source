...
const ShopClient = ({ categoryParam, subCategoryParam })=>{
    ...
    const categories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ShopClient.useMemo[categories]": ()=>[
                'All',
                ...new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$products$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].map({
                    "ShopClient.useMemo[categories]": (p)=>p.category
                }["ShopClient.useMemo[categories]"]))
            ]
    }["ShopClient.useMemo[categories]"], []);
...
_s(ShopClient, "R4bNKoXprGb4g+QzkwzQHyFjnY4=", false, function() {
    return [
...
//# sourceMappingURL=_0dc5068c._.js.map